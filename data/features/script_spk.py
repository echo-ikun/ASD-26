...
# 配置
# ======================
CSV_PATH = "/data/yyk_data/dataset/AVA/csv/train_loader.csv"
AUDIO_BASE = "/data/yyk_data/dataset/AVA/clips_audios/train"
OUT_FILE = "/data/yyk_data/dataset/AVA/features/train_embeddings_labels.npz"
...
# load model
########################
jit_model = torch.jit.load("/data/yyk_data/AVA/vad-open-silero/src/models/silero_vad.jit")
jit_model.eval()
